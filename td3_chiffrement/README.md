...
2. Envoyer une clé via SFTP
   - Format de connexion demandé: `utilisateur@ip_ou_hote`
...
- Cible: `utilisateur@ip_ou_hote`
- IPv6 accepté: `utilisateur@[2001:db8::1]`
- Le script valide le port, le fichier local, les identifiants, et crée les dossiers distants intermédiaires si nécessaire.
